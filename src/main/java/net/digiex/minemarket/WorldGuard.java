...
public class WorldGuard {
	...
	public static class MarketFlag extends StateFlag {
		public static MarketFlag flag = new MarketFlag();
	...
	boolean canModifyBlockHere(Location location) {
		ApplicableRegionSet regions = getApplicableRegions(location);
		return MarketFlag.setAllowsFlag(regions);
	}
}